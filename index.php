...
<div class="container w-full md:max-w-3xl mx-auto pt-40 pb-40">
	<div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal">
		...
		<p class="pt-20 text-justify">Mi nombre es Nisa Delgado. Nací, crecí y vivo en Maracaibo, Venezuela. Tengo 32 años. Soy Técnico Superior Universitario en Informática graduado en el Instituto Universitario de Tecnología Readic UNIR en diciembre de 2015.</p>
