...
<div class="container w-full md:max-w-3xl mx-auto pt-40 pb-40">
	<div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal">
		<p class="mb-5" x-text="contact.hello ?? $el.textContent">¡Hola!</p>

		<p class="mb-20" x-text="contact.intro ?? $el.textContent">
			Si necesitas contactarme, deja un mensaje en esta sección y tan pronto como pueda me pondré en contacto contigo.
		</p>
		...
		<form>
			...
			<div class="w-full grid grid-cols-2 mb-5">
				<div>
					<label x-text="contact.name ?? $el.textContent" for="name">Nombre</label>
				</div>
			...
			<div class="w-full grid grid-cols-2 mb-5">
				<div>
					<label x-text="contact.email ?? $el.textContent" for="email">Correo electrónico</label>
				</div>
			...
			<div class="w-full grid grid-cols-2 mb-5">
				<div>
					<label x-text="contact.subject ?? $el.textContent" for="subject">Asunto</label>
				</div>
			...
			<div class="w-full grid grid-cols-2 mb-5">
				<div>
					<label x-text="contact.message ?? $el.textContent" for="message">Mensaje</label>
				</div>
